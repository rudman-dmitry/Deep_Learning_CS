...
def create_train_validation_loaders(
    ...
    ds_train, ds_val = torch.utils.data.random_split(l, [train_size, val_size])
    
    # Samplers
    train_samp = torch.utils.data.SubsetRandomSampler(ds_train)
    valid_samp = torch.utils.data.SubsetRandomSampler(ds_val)
